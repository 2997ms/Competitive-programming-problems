...
void bfs(int i,int j)
{
	...
	while(x_x.size())
	{
		...
		if(value[temp_x+1][temp_y]!='#' && visit[temp_x+1][temp_y]==0&&temp_x<row-1)
		{
		...
		if(value[temp_x][temp_y+1]!='#' && visit[temp_x][temp_y+1]==0&&temp_y<col-1)
		{
		...
		if( value[temp_x-1][temp_y]!='#' && visit[temp_x-1][temp_y]==0 && temp_x>2)
		{
			visit[temp_x-1][temp_y]=1;
		...
		if(value[temp_x][temp_y-1]!='#' && visit[temp_x][temp_y-1]==0&&temp_y>2)
		{
			visit[temp_x][temp_y-1]=1;
